...
from core.mixins import product_mixins
...
class ReadOnlyModelViewSet(product_mixins.RetrieveModelMixin,
                           product_mixins.ListModelMixin,
                           GenericViewSet):
    """
...
class ModelViewSet(product_mixins.CreateModelMixin,
                   product_mixins.RetrieveModelMixin,
                   product_mixins.UpdateModelMixin,
                   product_mixins.DestroyModelMixin,
                   product_mixins.ListModelMixin,
                   GenericViewSet):
    """
