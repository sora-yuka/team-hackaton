...
from core.mixins import comment_mixins
...
class ReadOnlyModelViewSet(comment_mixins.RetrieveModelMixin,
                           comment_mixins.ListModelMixin,
                           GenericViewSet):
    """
...
class ModelViewSet(comment_mixins.CreateModelMixin,
                   comment_mixins.RetrieveModelMixin,
                   comment_mixins.DestroyModelMixin,
                   comment_mixins.UpdateModelMixin,
                   comment_mixins.ListModelMixin,
                   GenericViewSet):
    """
