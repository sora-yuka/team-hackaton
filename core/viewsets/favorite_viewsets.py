...
from core.mixins import favorite_mixins
...
class ReadOnlyModelViewSet(favorite_mixins.RetrieveModelMixin,
                           favorite_mixins.ListModelMixin,
                           GenericViewSet):
    """
...
class ModelViewSet(favorite_mixins.CreateModelMixin,
                   favorite_mixins.RetrieveModelMixin,
                   favorite_mixins.DestroyModelMixin,
                   favorite_mixins.ListModelMixin,
                   GenericViewSet):
    """
