...
class ReadOnlyModelViewSet(order_mixins.RetrieveModelMixin,
                           order_mixins.ListModelMixin,
                           GenericViewSet):
    """
...
class ModelViewSet(order_mixins.CreateModelMixin,
                   order_mixins.RetrieveModelMixin,
                   order_mixins.DestroyModelMixin,
                   order_mixins.UpdateModelMixin,
                   order_mixins.ListModelMixin,
                   GenericViewSet):
    """
